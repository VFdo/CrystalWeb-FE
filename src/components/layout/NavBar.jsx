      ...
      <div className="container-fluid">
        ...
        <Link to={"/"} className="link">
          <h4 className="logo-text">
            CRYSTAL
            <br />
            <span className="logo-text2"> Animal Hospital</span>
          </h4>
        </Link>
        <button
        ...
        <div className="collapse navbar-collapse " id="navbarScroll">
          <ul className="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
              ...
              <div>
                <li className="nav-item dropdown">
                  ...
                  >
                    ...
                    <li>
                      <Link to={"/existing-products"} className="dropdown-item">
                    ...
                    <li>
                      <Link to={"/attendance-veiw"} className="dropdown-item">
                        View Attendance
                      </Link>
                    </li>
                    <li>
                      <Link to={"/attendance-form"} className="dropdown-item">
                        Mark Attendance
                      </Link>
                    </li>
                  </ul>
            ...
            {userType === "CLIENT" && (
              <div>
                <li className="nav-item">
                  <NavLink className="nav-link" aria-current="page" to={"/pet"}>
                    Pets
                  </NavLink>
                </li>
              </div>
